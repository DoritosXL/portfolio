...
import base_logo from "../img/favicon.ico"
...
const fitness_pall = `Fitness-pall is een web app om nieuwe records met betrekking tot oefeningen aan te geven. Progressie van oefeningen is vervolgens aangegeven in een grafiek. Het project is aangemaakt om zo simpel mogelijk oefeningen door te geven en data terug krijgen.`

const ha_pictures = `Ha-pictures is een web app met inlogsysteem voor het individueel uploaden en inzien van afbeeldingen. Het project is aangemaakt naar aanleiding van mijn interesse in fotografie.`
